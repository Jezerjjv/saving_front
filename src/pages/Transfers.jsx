...
const styles = {
  ...
  table: { width: '100%', minWidth: 560, borderCollapse: 'collapse', background: 'var(--surface)' },
  ...
  thActions: { textAlign: 'right', padding: '0.4rem 0.6rem', borderBottom: '1px solid var(--border)', background: 'var(--bg)', fontWeight: 600, fontSize: '0.85rem', width: 120, minWidth: 120 },
  tr: { borderBottom: '1px solid var(--border)' },
  td: { padding: '0.4rem 0.6rem', fontSize: '0.9rem' },
  tdActions: { padding: '0.25rem 0.6rem', textAlign: 'right', display: 'flex', gap: '0.25rem', alignItems: 'center', justifyContent: 'flex-end', flexWrap: 'nowrap', minWidth: 120 },
